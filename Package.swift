...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.40.0/tuist.artifactbundle.zip",
            checksum: "b76bd80a526d2efa973613871554e74b5db7f167324175b19cfd8cb077e88a5f"
        ),
    ],
