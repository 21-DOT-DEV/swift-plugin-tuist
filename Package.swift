...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.49.1/tuist.artifactbundle.zip",
            checksum: "1914597243bd4311dcbf8412a01db6687e7645a638b4fa8123ea6222afa46588"
        ),
    ],
