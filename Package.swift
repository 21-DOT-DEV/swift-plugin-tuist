...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.80.0/tuist.artifactbundle.zip",
            checksum: "fbc0b447ecaed702c64e42eaf633a6a05d6b7d4f97ea1729317b4cf396b32cf6"
        ),
    ],
