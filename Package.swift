...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.84.2/tuist.artifactbundle.zip",
            checksum: "59787663f5940a1c377ea796f7af7243846c1d883805faad0a42d753d5848470"
        ),
    ],
