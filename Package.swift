...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.25.0/tuist.artifactbundle.zip",
            checksum: "b440be9a2cfa3739d0f9e02f96559882f91d3d39b1a86147e8af027047fd419f"
        ),
    ],
