...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.53.3/tuist.artifactbundle.zip",
            checksum: "1eccf5675da12808a118a255c13ec9dcfb74d3f007a9db5a9476008795e8f657"
        ),
    ],
