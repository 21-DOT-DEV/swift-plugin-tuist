...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.48.1/tuist.artifactbundle.zip",
            checksum: "62d22315d1cf657d204cd4f3e01bf403461e894a34741b738ed8060dc5c575c1"
        ),
    ],
