...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.130.2/tuist.artifactbundle.zip",
            checksum: "5bcd480e29cb087c0589ca58349ba73f3e5dc5945ca0afe7a5a400b780f16049"
        ),
    ],
