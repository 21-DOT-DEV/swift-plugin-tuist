...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.200.1/tuist.artifactbundle.zip",
            checksum: "47e78fbdd42adb245b191d46c722d72068f55360c0702f42d157c2efd0077ef8"
        ),
    ],
