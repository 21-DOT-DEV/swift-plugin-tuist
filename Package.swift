...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.142.0/tuist.artifactbundle.zip",
            checksum: "5ff68342936b703d92071fa2633113b2ca47e770491b572b3f4598fa2692fcb3"
        ),
    ],
