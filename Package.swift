...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.129.0/tuist.artifactbundle.zip",
            checksum: "9074425d02b0ea80e1c97fa75f1a8a1e09b7ce7b288cc5fb05507ee0057f5638"
        ),
    ],
