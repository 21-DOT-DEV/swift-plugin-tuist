...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.146.1/tuist.artifactbundle.zip",
            checksum: "3a98039034a78d54e0cb0de77bf828afd9a8893b5547cfd1ea0b39138b0e292b"
        ),
    ],
