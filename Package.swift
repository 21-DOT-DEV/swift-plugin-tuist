...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.95.0/tuist.artifactbundle.zip",
            checksum: "6a3877cb016120ac57d1a4dc6ac405f7fa476da668bfaa1fecfdac030eb74419"
        ),
    ],
