...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.29.0/tuist.artifactbundle.zip",
            checksum: "4342fd9d8eb20db40a382c12a7c094a05b02e7cad31e1f29b943dcf42fe1931b"
        ),
    ],
