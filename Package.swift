...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.99.0/tuist.artifactbundle.zip",
            checksum: "9326a28b9c016b4bacfda54ca8a8710a457b0542552fc33102e4145611bf8071"
        ),
    ],
