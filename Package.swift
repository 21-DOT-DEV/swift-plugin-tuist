...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.133.4/tuist.artifactbundle.zip",
            checksum: "ba98e1b659ab49d8065138d2b11bbee59dc482cdeccfd93b20fc9cd2e6b948a3"
        ),
    ],
