...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.65.5/tuist.artifactbundle.zip",
            checksum: "2f13987727a60af0d2bf5895e51812f39af47c5816a3e02914386125c4c8ac5b"
        ),
    ],
