...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.21.2/tuist.artifactbundle.zip",
            checksum: "43d95f3317385d4e763ca2d53209fb551219b9ce8a9e5ea3d5f37dd4c0fd2cc6"
        ),
    ],
