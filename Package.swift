...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.194.4/tuist.artifactbundle.zip",
            checksum: "277253d5610dfa870388bf476eec8421c80621c7c7a6de1dc9dea5d2292282a9"
        ),
    ],
