...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.161.1/tuist.artifactbundle.zip",
            checksum: "3b05c9da392edbd887c5a0941ef988af8bc32cf1ff7d6cf13943929baa454bc5"
        ),
    ],
