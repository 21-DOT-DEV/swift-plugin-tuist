...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.181.1/tuist.artifactbundle.zip",
            checksum: "b7547d34082f25e1d4de59e37c202e71285aea50f4c4949bb3077b4883a1252b"
        ),
    ],
