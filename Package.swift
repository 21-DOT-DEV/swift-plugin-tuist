...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.130.0/tuist.artifactbundle.zip",
            checksum: "c0451159795690dd9324af42ac4a7a6c9007a763c457954eb706061ec29838ca"
        ),
    ],
