...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.191.5/tuist.artifactbundle.zip",
            checksum: "ff29d7d5a14f31ca637d08a0cb431cee9f9481f60fc9e6564c523fc521272def"
        ),
    ],
