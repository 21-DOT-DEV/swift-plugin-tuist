...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.52.0/tuist.artifactbundle.zip",
            checksum: "4897619b2834e35bba58831230eb07da3ab1081c6e099001a372cabf9e5598be"
        ),
    ],
