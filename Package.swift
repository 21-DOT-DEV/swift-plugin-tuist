...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.129.1/tuist.artifactbundle.zip",
            checksum: "483e32dceba5334c009779c1589d1ca8a6b0ed237bcfccf05b79b978cd12024e"
        ),
    ],
