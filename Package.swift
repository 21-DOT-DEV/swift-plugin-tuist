...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.85.2/tuist.artifactbundle.zip",
            checksum: "b88ffa28b0bb0049fe4553ec1e567a5251065e5a40745ca2a68b36e5ad682138"
        ),
    ],
