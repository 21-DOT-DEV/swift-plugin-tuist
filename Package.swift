...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.193.1/tuist.artifactbundle.zip",
            checksum: "197400bc69425bc816aec998e22668aaf0870c2f4e4f556d186a58cca3ef8326"
        ),
    ],
