...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.44.1/tuist.artifactbundle.zip",
            checksum: "f7a5a02bbae10a66496e219c2e3f04b16684ff0fc94a5aa96ae15fe763870d93"
        ),
    ],
