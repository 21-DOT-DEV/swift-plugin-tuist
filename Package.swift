...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.94.0/tuist.artifactbundle.zip",
            checksum: "0dd6490b516d7be08054c7ccecd729da2dd8baa0910079d2bd45fc41681a19e7"
        ),
    ],
