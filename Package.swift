...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.37.0/tuist.artifactbundle.zip",
            checksum: "a17d841f23e076eb0763af61d128ae61c39a7494b17402f299570543ead5c009"
        ),
    ],
