...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.82.3/tuist.artifactbundle.zip",
            checksum: "be05c78364271f37e8e987313c5cdb709a8dbf8dbbcba496dab058bd60189778"
        ),
    ],
