...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.179.1/tuist.artifactbundle.zip",
            checksum: "7df34dc4b97d945ed8e8f4999c8cca49a2f4ba7ae847f71a4b8e67122c407c8c"
        ),
    ],
