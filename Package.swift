...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.155.3/tuist.artifactbundle.zip",
            checksum: "e77cfe536e7059a198a14d75d00f460045357dd03f2aa54e14ab7ec1a3e901c2"
        ),
    ],
