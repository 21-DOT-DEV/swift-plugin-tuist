...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.171.0/tuist.artifactbundle.zip",
            checksum: "1f98cccc08ced0abe0602caa457cf02474ef73a1a2f9e731ccd59f33cb30bc7a"
        ),
    ],
