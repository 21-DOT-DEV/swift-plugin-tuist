...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.138.0/tuist.artifactbundle.zip",
            checksum: "d02e1750bbcabed81cdf35b0ed3ebea0ff97ed63aef427f2ede4b6f552209692"
        ),
    ],
