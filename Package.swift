...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.116.1/tuist.artifactbundle.zip",
            checksum: "e48ae4dbfe16f14d3150190833bff8e47cc982bc9975d9dd547449a294294be3"
        ),
    ],
