...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.195.2/tuist.artifactbundle.zip",
            checksum: "f0cc26729e0b4f35c95c375246555463c4e8681bdd2a66c7dda7a9ae4fee396b"
        ),
    ],
