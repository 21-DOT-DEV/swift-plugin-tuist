...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.193.5/tuist.artifactbundle.zip",
            checksum: "59a78f73ae5e2efc2d1375797e3e0bfb94813a280b52bd146f53196be2ad85cd"
        ),
    ],
