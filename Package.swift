...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.98.0/tuist.artifactbundle.zip",
            checksum: "3bdb6fcdc0688e3033af25f050a21d049959fd5bc404c27188d3e6036bd48856"
        ),
    ],
