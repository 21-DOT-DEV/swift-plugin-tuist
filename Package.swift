...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.78.1/tuist.artifactbundle.zip",
            checksum: "36fa77440bb606e43f4a5d6869797095f691e419403613c9e510c8fa58105f54"
        ),
    ],
