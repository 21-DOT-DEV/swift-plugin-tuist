...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.202.4/tuist.artifactbundle.zip",
            checksum: "5718241f0d55200388e37058a7a47517a76ea8adb03dd2d6455600f440dc098c"
        ),
    ],
