...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.191.8/tuist.artifactbundle.zip",
            checksum: "06632bfa5a38b0c10bf4b65849cc432bd7b7dc4e7f0ba93905c9e39b0880b2c7"
        ),
    ],
