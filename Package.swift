...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.62.0/tuist.artifactbundle.zip",
            checksum: "c7fe4e5448b5c012d7dede9df1908765712dba326c307987bfc09cafb4ce003c"
        ),
    ],
