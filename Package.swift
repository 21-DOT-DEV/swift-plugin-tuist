...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.169.0/tuist.artifactbundle.zip",
            checksum: "419fef799fb7b4b81eaa89c267fbec3523d672d60542b5ddc75ee7601418fd6e"
        ),
    ],
