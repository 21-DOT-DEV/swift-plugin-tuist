...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.28.0/tuist.artifactbundle.zip",
            checksum: "0225555bab3b0e01550edf700a24fc7759a9f7ef78c5bc96a6324950d420ab66"
        ),
    ],
