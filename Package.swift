...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.32.1/tuist.artifactbundle.zip",
            checksum: "03b9f40e714379ab7491f15187528e4e4e8c202e897d49d07afd5f5d210cc881"
        ),
    ],
