...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.186.2/tuist.artifactbundle.zip",
            checksum: "9ed08e61b8cd57c915d50b049bfdd117935098e2c550aa54012ab8e678c4bc16"
        ),
    ],
