...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.136.0/tuist.artifactbundle.zip",
            checksum: "ff311499ac03fc0621036053ccfa56701eb2b795a0a51667de16d19228103fa3"
        ),
    ],
