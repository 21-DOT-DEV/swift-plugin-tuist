...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.135.2/tuist.artifactbundle.zip",
            checksum: "dbb0a6e9aa37851d71b673e6fa2bb99ccf4d6ad381593df437ebc818e0c30e35"
        ),
    ],
