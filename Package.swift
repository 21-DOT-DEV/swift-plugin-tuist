...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.156.0/tuist.artifactbundle.zip",
            checksum: "cfb7d22bfa1ebfac06b515f50c6b9733d63a8351adb2fa98062c58b67639a591"
        ),
    ],
