...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.65.6/tuist.artifactbundle.zip",
            checksum: "37760d114d9c50dc067444b9927a039dce2fe663202b72d95569b7c12f006a6a"
        ),
    ],
