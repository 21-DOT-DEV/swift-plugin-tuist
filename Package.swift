...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.171.2/tuist.artifactbundle.zip",
            checksum: "aa082625b1a9089b966926f1a77a4430893d9a44c5181a8d7448e51d52df58c7"
        ),
    ],
