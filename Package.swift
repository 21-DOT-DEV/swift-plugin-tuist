...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.180.0/tuist.artifactbundle.zip",
            checksum: "a030b6ecf9a5c35509e78e5d83a7514ee5960a89823062134a7ef298ad501d7b"
        ),
    ],
