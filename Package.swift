...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.20.0/tuist.artifactbundle.zip",
            checksum: "8d207e2dfc82b8373a4ca71630615a009f4bc1c7de08b8142eaf0fad515938d3"
        ),
    ],
