...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.160.3/tuist.artifactbundle.zip",
            checksum: "b1261539443417600e5e94319e7cd3086bfb8f37bb8ad3129a09669244e31edc"
        ),
    ],
