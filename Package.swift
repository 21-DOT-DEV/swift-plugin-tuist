...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.202.1/tuist.artifactbundle.zip",
            checksum: "6c8ad905bd8e6a5e5f88dd47274ef4f8a2bf39c6587439aa125d2f2e1b8ee84b"
        ),
    ],
