...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.54.0/tuist.artifactbundle.zip",
            checksum: "d0ad81111f6c466413fda33d5bd5ccb9ce28769f0bf217afca6f49f87da4442c"
        ),
    ],
