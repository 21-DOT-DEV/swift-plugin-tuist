...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.197.0/tuist.artifactbundle.zip",
            checksum: "b069c34d39d6d71b31fbd2fad7e8e0e62395945fc6ec1327d457f3c10e635fdd"
        ),
    ],
