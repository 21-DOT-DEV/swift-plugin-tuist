...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.131.2/tuist.artifactbundle.zip",
            checksum: "deb154899f89cdbd4347ef83b45a8da0e3301acf46784d59d536a77545844845"
        ),
    ],
