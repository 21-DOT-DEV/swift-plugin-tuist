...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.124.0/tuist.artifactbundle.zip",
            checksum: "bf47b7fdea88eb687a67992e445d1a40293d1102d15f9b34cf1b769fd56ef759"
        ),
    ],
