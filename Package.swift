...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.50.1/tuist.artifactbundle.zip",
            checksum: "8da8c20abc6a333a9bb1a1eeb14248beb859c4ecc814542391aa3c9d7cd7da8c"
        ),
    ],
