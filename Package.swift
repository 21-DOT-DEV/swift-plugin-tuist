...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.59.1/tuist.artifactbundle.zip",
            checksum: "fc9c2cf2afcb854edad5a163966243ceba8bbc1ca4d4d6410b65f6d98a4e91de"
        ),
    ],
