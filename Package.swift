...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.113.0/tuist.artifactbundle.zip",
            checksum: "fe2e6c0040ed31516647a9ab2013c6dfccbd8f979840fc6fd963a2f4ef4759cd"
        ),
    ],
