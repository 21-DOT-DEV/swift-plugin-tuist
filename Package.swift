...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.52.1/tuist.artifactbundle.zip",
            checksum: "268dae50259198a9e64c3ade2de1abb309af6289d0eac6f571d409e97bb3c9de"
        ),
    ],
