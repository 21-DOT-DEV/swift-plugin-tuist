...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.155.4/tuist.artifactbundle.zip",
            checksum: "8291682c6f59784c92a55930bef5d086169968fe7b47e6512e9d5360c00376f9"
        ),
    ],
