...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.29.1/tuist.artifactbundle.zip",
            checksum: "1f3d748489f0bb2ae387c9dc35c70684e2f8e94958b4eefd52bcadbbb6b52514"
        ),
    ],
