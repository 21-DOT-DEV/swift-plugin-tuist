...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.159.0/tuist.artifactbundle.zip",
            checksum: "9d85a6a5d29bb7d92f1a5c48aae30e4c3062f30ff7fb903376e7608f300efafe"
        ),
    ],
