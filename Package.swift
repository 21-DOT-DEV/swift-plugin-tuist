...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.183.0/tuist.artifactbundle.zip",
            checksum: "c2881ae3add8c0f8d80a592e12c1f048ba62cfd0a94660dab073bf306c7c877a"
        ),
    ],
