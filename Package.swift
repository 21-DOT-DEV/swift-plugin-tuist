...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.195.9/tuist.artifactbundle.zip",
            checksum: "a9d7eea679e327d33fb3821b0148eca8fdb27fab743541b2b3eae878d122f2cd"
        ),
    ],
