...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.58.0/tuist.artifactbundle.zip",
            checksum: "02828c388db3f7433408d8b1dd8d4cafd7f59612afb5ffda640ec565a0e1fa87"
        ),
    ],
