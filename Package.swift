...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.38.2/tuist.artifactbundle.zip",
            checksum: "cd0cb29bc01785a2f2c17060351b5d281ee92dbccd360539192aad07bbfb76cc"
        ),
    ],
