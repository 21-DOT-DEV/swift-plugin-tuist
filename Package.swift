...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.195.3/tuist.artifactbundle.zip",
            checksum: "d72e97c82b68a7f1659c18b5e70bd93d22237a34daeeb11e2832fcb0a8a48665"
        ),
    ],
