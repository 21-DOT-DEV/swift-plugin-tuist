...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.55.0/tuist.artifactbundle.zip",
            checksum: "0f6dba040f55c86602bf4a5562b94a95dff9c5cae4d37ca30c8564c02c9d50d7"
        ),
    ],
