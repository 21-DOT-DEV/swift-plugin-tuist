...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.174.4/tuist.artifactbundle.zip",
            checksum: "38031365ea96260b115d0cd0ed4587d2ec9950d60c13ab613ceca43ad48e400e"
        ),
    ],
