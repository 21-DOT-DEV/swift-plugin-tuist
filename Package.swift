...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.56.1/tuist.artifactbundle.zip",
            checksum: "c12cb2dadd70d8d8a08ff089a0b79f40cfd18fea8eb043be902be368442d79f8"
        ),
    ],
