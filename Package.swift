...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.193.3/tuist.artifactbundle.zip",
            checksum: "f8377bca6161f2552ff505935e14b7131fa25cbd1f0524d84e487c26c9b37df6"
        ),
    ],
