...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.166.0/tuist.artifactbundle.zip",
            checksum: "d40c551136a574ed4295e0e799c5b006e1580372e8b3731e4303796c62da37e8"
        ),
    ],
