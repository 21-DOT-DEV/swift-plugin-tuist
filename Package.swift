...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.101.0/tuist.artifactbundle.zip",
            checksum: "7cb73d89d112d8ce691c39e3f645981818e8bfb62e29821b939cbbcff0595acf"
        ),
    ],
