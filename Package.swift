...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.113.1/tuist.artifactbundle.zip",
            checksum: "3703c2fcabafc1c3d97798ed61df2877754d6932a806082c354c91c60ddc2552"
        ),
    ],
