...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.195.6/tuist.artifactbundle.zip",
            checksum: "2ce0b21ce584025a41fbdc86591afa1c7e702d99a688d9d4e7da49a261bf39b9"
        ),
    ],
