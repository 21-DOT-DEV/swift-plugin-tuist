...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.172.1/tuist.artifactbundle.zip",
            checksum: "434a2e9dda458e48196bc3d42e050623b588a9f77f80e01bf50c209c28efeb79"
        ),
    ],
