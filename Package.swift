...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.197.2/tuist.artifactbundle.zip",
            checksum: "386e5d76e086431a4fea68daf3343a8d7f5e17114253102d03e69402a7beb3e2"
        ),
    ],
