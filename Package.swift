...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.192.1/tuist.artifactbundle.zip",
            checksum: "61fc70f70b915f7c851e31c45d02b1c16e7f08db44f297e41f9637bf8365b10a"
        ),
    ],
