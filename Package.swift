...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.104.7/tuist.artifactbundle.zip",
            checksum: "7c88eb54ef68a3438da2688fdad385b2ccf3d94c9b50378cd9e264fa052a79f0"
        ),
    ],
