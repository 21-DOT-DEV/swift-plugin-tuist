...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.21.0/tuist.artifactbundle.zip",
            checksum: "4329c5fa2e6044ccd269cacd9fc0b083719df499b1cf9d0f35e61890f9418674"
        ),
    ],
