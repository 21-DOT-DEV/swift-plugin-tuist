...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.72.0/tuist.artifactbundle.zip",
            checksum: "f57681a1bf72496120a3f9399fba6eda45fcf512357bab3f0f5110fbf8723a25"
        ),
    ],
