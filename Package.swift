...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.128.1/tuist.artifactbundle.zip",
            checksum: "993782e9acb0c5ce6c5d476dfd11013c73504bbe8dc18354a07c1f8ab05c736b"
        ),
    ],
