...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.83.0/tuist.artifactbundle.zip",
            checksum: "ed4fcd85561e282f27cb331b7000c7a26a7f68047ffb458cdccdaaaf97b29676"
        ),
    ],
