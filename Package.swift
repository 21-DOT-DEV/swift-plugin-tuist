...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.195.12/tuist.artifactbundle.zip",
            checksum: "83fd6a0d1ed24ddae803b450e3c799dfd4bb8929e30994737c6d7eeb9a6ac3aa"
        ),
    ],
