...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.65.1/tuist.artifactbundle.zip",
            checksum: "a26fae5ccc9f373eb8cf20f7d5e3336e58ec666181af3996071c8074f0e25b2c"
        ),
    ],
