...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.128.2/tuist.artifactbundle.zip",
            checksum: "09eaac1ce0bccaaf074b0cb77e9aa90ea44d80eba7002dcb13084658376303c1"
        ),
    ],
