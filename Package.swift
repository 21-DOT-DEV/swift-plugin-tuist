...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.53.1/tuist.artifactbundle.zip",
            checksum: "fc27d36507260ca353215454ebaa15edda746b07213eeb19e2c8835944e40929"
        ),
    ],
