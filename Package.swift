...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.97.1/tuist.artifactbundle.zip",
            checksum: "0c2b0630eed97ae183a362004e71810562a34802e663b79750da3bf672c4f143"
        ),
    ],
