...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.123.0/tuist.artifactbundle.zip",
            checksum: "fbaa8d80df1812408bc5667273a4a1515ac81eb83c9a3f5d172f9447939a882f"
        ),
    ],
