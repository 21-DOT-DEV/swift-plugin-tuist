...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.79.4/tuist.artifactbundle.zip",
            checksum: "c0927106943883e48aba7fe1f17c4286dc08274555bc4c0f7fd27b047b1a80ac"
        ),
    ],
