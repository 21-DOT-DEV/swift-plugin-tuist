...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.170.0/tuist.artifactbundle.zip",
            checksum: "9d4658c7efb2cecc22a17a048f0cb4fa9faf896d6bdb4374a9c064ce20a19638"
        ),
    ],
