...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.65.4/tuist.artifactbundle.zip",
            checksum: "d0c8db81be75bbe70d34d1ecc9f536d8bd37975c11969793094b60a2e1757d36"
        ),
    ],
