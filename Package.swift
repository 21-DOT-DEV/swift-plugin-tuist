...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.55.5/tuist.artifactbundle.zip",
            checksum: "ae1ddd5d4e4200e4c70fb3a0d0f187558199d19450aa47825d4093f4c1971d99"
        ),
    ],
