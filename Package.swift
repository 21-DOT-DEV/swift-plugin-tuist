...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.202.2/tuist.artifactbundle.zip",
            checksum: "af26417f10ad52df36f45130db637ab8842871d85869a908306f2d1154603143"
        ),
    ],
