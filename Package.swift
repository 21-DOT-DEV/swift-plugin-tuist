...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.191.1/tuist.artifactbundle.zip",
            checksum: "8cc27c5b2c65e4050cab0c0ec3a3b0f287bcce72ed240811a4264e87ae4b0d53"
        ),
    ],
