...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.161.3/tuist.artifactbundle.zip",
            checksum: "76a0d83412d3242b1986cb175ff1b548ae5e9d6fcb1bb446a634f964d83e3f3f"
        ),
    ],
