...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.150.0/tuist.artifactbundle.zip",
            checksum: "cffd60338cf4fc52a9b63ee12da7a611338f9e73167484124ea839938ea68f82"
        ),
    ],
