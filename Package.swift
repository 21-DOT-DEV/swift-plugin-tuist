...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.104.1/tuist.artifactbundle.zip",
            checksum: "752271f5e95b1ab4092fe89daa6764317372ee97e798c3bc08bf7d1be572f191"
        ),
    ],
