...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.33.0/tuist.artifactbundle.zip",
            checksum: "f00e544f399fc91d3d494cfc79ee8fe42b7e0cc8892cac81318c2e6ab2bd83ba"
        ),
    ],
