...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.89.0/tuist.artifactbundle.zip",
            checksum: "4075a4c9a4c72ceb2c561724bc5d70c820c815b661acd69dffc742a0d6581321"
        ),
    ],
