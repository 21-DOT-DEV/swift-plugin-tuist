...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.198.3/tuist.artifactbundle.zip",
            checksum: "fbc676f66cef352477974d951ce8a6a0f1d7598e28b1ab87f424488104219c80"
        ),
    ],
