...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.172.0/tuist.artifactbundle.zip",
            checksum: "37657d3454110566a1d8c970079245e32dc9e360b3b57a40e9dff5feed5765e2"
        ),
    ],
