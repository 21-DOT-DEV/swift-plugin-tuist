...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.132.1/tuist.artifactbundle.zip",
            checksum: "b5e7825961e1dde45aa673bbf6073888cad221c45506d96299919f0fc3d56bd1"
        ),
    ],
