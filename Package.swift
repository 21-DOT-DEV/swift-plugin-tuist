...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.195.5/tuist.artifactbundle.zip",
            checksum: "88a04744f8cd30754b0d6f5f28251c4774ef7d8ece47822da8e3a8b1c65aae58"
        ),
    ],
