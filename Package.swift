...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.41.0/tuist.artifactbundle.zip",
            checksum: "73dc5757a1851d0b4db7d7872bcfc9c174774e930b0ef942adcca92aeaf36eae"
        ),
    ],
