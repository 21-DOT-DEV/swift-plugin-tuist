...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.34.0/tuist.artifactbundle.zip",
            checksum: "9e2770982a5172d02c1e83cef4fa3f91a2f8bc26e6b0b383b7e4e3ecf76d317a"
        ),
    ],
