...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.182.0/tuist.artifactbundle.zip",
            checksum: "a9fa321cb71884b44ec99f46c4081c7c249dec63be43e533a6d0df4b9662ae7e"
        ),
    ],
