...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.99.2/tuist.artifactbundle.zip",
            checksum: "83f85b9a8d64ba0a1d347e24af2ceb84a790b5bf18b838cc7862e3dc54edcb37"
        ),
    ],
