...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.200.5/tuist.artifactbundle.zip",
            checksum: "a864690a0f5f3c5d899dc1b0e41d70070fbfa01170ac3559955bb381ff2d2fac"
        ),
    ],
