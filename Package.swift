...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.59.2/tuist.artifactbundle.zip",
            checksum: "304d5f16ca72415a4a4994ca19350aae7e8d2ba5836228cc84c7e3be1ea57e76"
        ),
    ],
