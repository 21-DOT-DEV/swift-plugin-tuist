...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.192.3/tuist.artifactbundle.zip",
            checksum: "20d676e92464dacb29451d1a4f8ce02f83ff22cb76955f04a9171478f86dcb6d"
        ),
    ],
