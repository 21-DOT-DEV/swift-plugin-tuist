...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.57.0/tuist.artifactbundle.zip",
            checksum: "19efc7bdd1e4b867001a72e18f3558bb2ea50dfa9cd1b37a42863fabd7cc8d6d"
        ),
    ],
