...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.78.0/tuist.artifactbundle.zip",
            checksum: "091bd4b822f2d74abb2d7d80241f4994a84c226837ec21bef63ec95ce210c3dc"
        ),
    ],
