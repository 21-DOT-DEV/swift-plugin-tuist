...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.161.0/tuist.artifactbundle.zip",
            checksum: "7556f24cc8547068b4dfc276a59fc5656e82125280e4e7a59778db29e4df207b"
        ),
    ],
