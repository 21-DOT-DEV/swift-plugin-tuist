...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.154.2/tuist.artifactbundle.zip",
            checksum: "68f7affef35f4ad0cc1e464831f3c39084c69c192f6ca94a58dd1ab99b9af3ba"
        ),
    ],
