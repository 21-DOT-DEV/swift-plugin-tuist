...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.141.0/tuist.artifactbundle.zip",
            checksum: "e5aa6a54dedd83651e6d2ecf14ef953bfb733bca4a7b15a786a3d1d988041895"
        ),
    ],
