...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.188.4/tuist.artifactbundle.zip",
            checksum: "b2553782163e25298f3e5a223c40b04c73d79cb754fec1e27a0a32512d847967"
        ),
    ],
