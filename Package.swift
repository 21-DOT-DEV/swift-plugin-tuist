...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.193.2/tuist.artifactbundle.zip",
            checksum: "738390fd92c4055d845f71221c8c810a65d7236c3d22d16ab92fa977292fc5bb"
        ),
    ],
