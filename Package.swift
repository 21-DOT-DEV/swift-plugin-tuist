...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.192.4/tuist.artifactbundle.zip",
            checksum: "ca43b9fa38bc1cbedf71e09705e1dc15c3ebb9112dc023b9f3b7a7642ca37530"
        ),
    ],
