...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.38.1/tuist.artifactbundle.zip",
            checksum: "e1bfdfbd007f2ed4b6091825c0b92f757b28af8faee120eebea0aa387ef7ca5a"
        ),
    ],
