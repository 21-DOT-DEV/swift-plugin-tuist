...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.124.1/tuist.artifactbundle.zip",
            checksum: "d126a0fd628479a5e878bc726a1169077f0f7db7177c1b08f826c449d55ed0c7"
        ),
    ],
