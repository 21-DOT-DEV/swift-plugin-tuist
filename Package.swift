...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.76.1/tuist.artifactbundle.zip",
            checksum: "dae736a2c45546ca38d3c0dd4334c76305a8c4b0901b432dddb854f9bffc942f"
        ),
    ],
