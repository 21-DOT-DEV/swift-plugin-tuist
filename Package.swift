...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.86.3/tuist.artifactbundle.zip",
            checksum: "b6d201648295b16f8a52f486666fb87935a35dc69cd3a4291a6d882085379543"
        ),
    ],
