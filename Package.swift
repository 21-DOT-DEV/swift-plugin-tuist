...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.200.4/tuist.artifactbundle.zip",
            checksum: "d3ab7d64ee5fffc34cdd92e5663ce0983c9a1fe0c9487ec6eb77b3e0f63d04da"
        ),
    ],
