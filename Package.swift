...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.168.0/tuist.artifactbundle.zip",
            checksum: "e848105d0acaa47cf7273f6848d4a0c910fff60711783783401f9f5f80e11ff3"
        ),
    ],
