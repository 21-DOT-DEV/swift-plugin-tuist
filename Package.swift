...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.54.3/tuist.artifactbundle.zip",
            checksum: "9d55eedaf4f0f494935be7d7334a2e863310d0cabfdde445ba8b87acf659a851"
        ),
    ],
