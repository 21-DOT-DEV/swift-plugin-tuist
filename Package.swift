...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.107.2/tuist.artifactbundle.zip",
            checksum: "0d3297736377c6b5d635450b62f305c090b64a827a3f5050766814a55935b1c3"
        ),
    ],
