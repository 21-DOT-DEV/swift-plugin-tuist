...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.167.0/tuist.artifactbundle.zip",
            checksum: "c0e29e42097a65d58db7189c132365634c9d463f320c92b1d8a9781479787529"
        ),
    ],
