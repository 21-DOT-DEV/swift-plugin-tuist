...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.118.1/tuist.artifactbundle.zip",
            checksum: "62182540ae88b613b1f1801d5c26e7863437cc167e0d10da0e0ce170e58cdcc8"
        ),
    ],
