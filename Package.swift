...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.122.2/tuist.artifactbundle.zip",
            checksum: "44da621c233820ef2941bc6b61b45cb348a79a3a6700810bd09ccded7d2b2590"
        ),
    ],
