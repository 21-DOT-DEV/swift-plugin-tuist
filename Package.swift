...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.28.2/tuist.artifactbundle.zip",
            checksum: "50fc62a12559e6cfd4571964b5e4679a2ec893a82c50b17be708f2436c84ed5a"
        ),
    ],
