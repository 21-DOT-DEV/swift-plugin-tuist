...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.153.0/tuist.artifactbundle.zip",
            checksum: "9527541cf4846ce4a2d607d17c5e23ccc0b1a74f72b11ab20a03b22b03fd01d5"
        ),
    ],
