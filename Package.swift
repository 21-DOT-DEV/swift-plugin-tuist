...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.91.1/tuist.artifactbundle.zip",
            checksum: "ba3d635a8da257b008bde06856cb86f7555f634b6794a02666139c6adb4a870c"
        ),
    ],
