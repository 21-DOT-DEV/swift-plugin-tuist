...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.118.0/tuist.artifactbundle.zip",
            checksum: "77835dcddb79dcccd4a98b493b1c7e2c624b485941036494e4178f5cd88595c2"
        ),
    ],
