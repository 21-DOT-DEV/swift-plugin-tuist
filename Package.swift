...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.71.0/tuist.artifactbundle.zip",
            checksum: "3785c8cab9ad76125a49e0cd8b547d2aa53789c4fa75a6f714a2060e3180e1e0"
        ),
    ],
