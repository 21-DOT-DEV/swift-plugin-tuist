...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.152.0/tuist.artifactbundle.zip",
            checksum: "0b6a731256ebea465f7ce61db0a84bfa4c2514891ad55999f9be4ea0ec6d7755"
        ),
    ],
