...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.198.1/tuist.artifactbundle.zip",
            checksum: "2bd9fc0c5a2146835ef49c0b42587afedf5850e91ab0c2ca49fce033329b3b4f"
        ),
    ],
