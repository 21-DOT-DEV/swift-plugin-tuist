...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.147.0/tuist.artifactbundle.zip",
            checksum: "3025e9e5d96baeaa1e9ed42e622df31168b796d69431e844b6c1acc966e5ca59"
        ),
    ],
