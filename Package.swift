...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.184.0/tuist.artifactbundle.zip",
            checksum: "e63ad601b6c3e84897a1fcdb49107105a988a60fd4d57dc72f8f30e0c648ac6f"
        ),
    ],
