...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.203.4/tuist.artifactbundle.zip",
            checksum: "d8806d4ead6ba04f9ba24bddb992ad08ffe0bffbe8de88739031029a60f898a9"
        ),
    ],
