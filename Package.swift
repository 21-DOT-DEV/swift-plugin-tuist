...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.127.0/tuist.artifactbundle.zip",
            checksum: "8c836d1302cc7ba4aa20f13592d7be2063554f2833cb435aa696b7aa593f8a7c"
        ),
    ],
