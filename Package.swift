...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.43.1/tuist.artifactbundle.zip",
            checksum: "bbfae553bde6d82ee83f22532827decdc141e1a9934bae4342b4cfa0da91cd73"
        ),
    ],
