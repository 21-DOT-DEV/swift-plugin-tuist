...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.34.3/tuist.artifactbundle.zip",
            checksum: "fa56c45fd771d5e9215d9b46fa9b54d8ec1d41abfaaf7a4509b6ffecc3caa24a"
        ),
    ],
