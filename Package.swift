...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.81.1/tuist.artifactbundle.zip",
            checksum: "df2a1681258043f9d928354e98776bfe2490d13485fffa965a37187f4d59df32"
        ),
    ],
