...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.191.4/tuist.artifactbundle.zip",
            checksum: "a67a8ff1fba7f4621853a1e448911858ca7326fc82acbfd892c10d1fffa1a68d"
        ),
    ],
