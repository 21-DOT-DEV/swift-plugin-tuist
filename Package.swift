...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.155.5/tuist.artifactbundle.zip",
            checksum: "653f8f31791f37114bca955b47fc5dc71fba91dc777a5be2f77feb4f8f0d640a"
        ),
    ],
