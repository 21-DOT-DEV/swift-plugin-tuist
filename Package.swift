...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.82.0/tuist.artifactbundle.zip",
            checksum: "9334fb1b41f9cee3ba7b27ebbd0c7880a7250464fc1c609cd54339134635567a"
        ),
    ],
