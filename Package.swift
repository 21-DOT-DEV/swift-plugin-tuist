...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.39.1/tuist.artifactbundle.zip",
            checksum: "efc14d9e9f371f4a6dab18e1284d496cc0ef8cf8a3bd5bbef342e34569550146"
        ),
    ],
