...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.119.1/tuist.artifactbundle.zip",
            checksum: "896c2cd075fc08d131608227978d59efe101df791fa6481b0fff7c37407016f4"
        ),
    ],
