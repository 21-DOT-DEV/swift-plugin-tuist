...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.79.7/tuist.artifactbundle.zip",
            checksum: "d47ab6ac98ef18307f8cafbf7069c8b492f8012e9236114adf2d3bd95444840b"
        ),
    ],
