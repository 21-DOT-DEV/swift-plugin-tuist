...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.46.1/tuist.artifactbundle.zip",
            checksum: "0b8a59977bccefc1f22c7be58abc6fa4794323e4645b309295f063f850503e8f"
        ),
    ],
