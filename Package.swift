...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.148.1/tuist.artifactbundle.zip",
            checksum: "0dd7396b44e141ebe352444c6868c518e30ddf3654b190e5ba06e9b6bf8c5aa0"
        ),
    ],
