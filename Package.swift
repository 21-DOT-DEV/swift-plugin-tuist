...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.65.0/tuist.artifactbundle.zip",
            checksum: "da175174bf50b201126e13a2419327b56cbde6ad9523cbbc68b9a9c21e69fd9f"
        ),
    ],
