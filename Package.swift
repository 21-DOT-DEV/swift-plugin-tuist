...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.109.0/tuist.artifactbundle.zip",
            checksum: "b1c6a520b606ccf18c769b63efce70d573dfba16a3f10e74d39fa09e29877398"
        ),
    ],
