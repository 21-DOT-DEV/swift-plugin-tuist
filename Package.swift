...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.177.0/tuist.artifactbundle.zip",
            checksum: "34870581736346f5cc59a1172f6ef0087b796e983471bcda0883ae0b91b91e18"
        ),
    ],
