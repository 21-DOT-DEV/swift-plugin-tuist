...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.66.1/tuist.artifactbundle.zip",
            checksum: "47fad710b1c1b3f11f2329ab6a9906c10a8ff98f5e9abd3d22d755ee6834cfa5"
        ),
    ],
