...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.192.0/tuist.artifactbundle.zip",
            checksum: "61a61b7dd50e5e9ea50037c573a82ca6fc9c7e6f28af0fdba85f531b4d6c3ae2"
        ),
    ],
