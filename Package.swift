...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.195.0/tuist.artifactbundle.zip",
            checksum: "4a25cdb63343dbea5613a72b0a91af4f235540695a62ff6649d2c094b1b28c07"
        ),
    ],
