...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.195.11/tuist.artifactbundle.zip",
            checksum: "7d0b806fc456ba52a3dabf97e1fcecd8fd3bd9b0604e4af765aa7a5d8c8faa65"
        ),
    ],
