...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.195.7/tuist.artifactbundle.zip",
            checksum: "4c50759bc39252e528cdaba1ec2691282b6ea07c987fe9250691a9557aa8c4d9"
        ),
    ],
