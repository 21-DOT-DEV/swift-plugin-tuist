...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.195.10/tuist.artifactbundle.zip",
            checksum: "ccfba50dc70dd4db1971906a2228e3f911f7d5125766a4cb52004f7b2806aed5"
        ),
    ],
