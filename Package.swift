...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.52.2/tuist.artifactbundle.zip",
            checksum: "1d54ef1a20e15cceb1f8ac820efc781bcfbee3440b3ba15605c08e4a1bb03edb"
        ),
    ],
