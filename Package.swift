...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.119.3/tuist.artifactbundle.zip",
            checksum: "f52cd40a82e72695696b5ae1216bc600c95cc50b628182e6f504925412bdb084"
        ),
    ],
