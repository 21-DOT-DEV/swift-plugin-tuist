...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.48.2/tuist.artifactbundle.zip",
            checksum: "ee099f22685bea5aa846914486530c4fc6b7040b4993217fe709ebde82801cbf"
        ),
    ],
