...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.169.2/tuist.artifactbundle.zip",
            checksum: "21c9a70ba811545a1f3f878839c9b7e76f63ea154bff9fd616c417434ebd9a43"
        ),
    ],
