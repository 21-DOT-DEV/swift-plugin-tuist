...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.181.0/tuist.artifactbundle.zip",
            checksum: "09120cfcdfedd65533d619a17f3c5e6656d45d1f9fe0977b8750cca85ebad21b"
        ),
    ],
