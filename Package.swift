...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.140.0/tuist.artifactbundle.zip",
            checksum: "cb672ae04175550f258c33041a78f9512f1f4e9b880c3b29559500ad86874496"
        ),
    ],
