...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.158.2/tuist.artifactbundle.zip",
            checksum: "84edeadd8fed272c50437d0dcea93d14f97e2115dc13c710c75c650e23eaba1f"
        ),
    ],
