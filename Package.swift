...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.202.3/tuist.artifactbundle.zip",
            checksum: "90a992349fc5cf841e5398ada9a4537ce7342f3f7c1c5ac52eb0656b66ecbb61"
        ),
    ],
