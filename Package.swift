...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.105.0/tuist.artifactbundle.zip",
            checksum: "1f94c82e9bfcbe0d84c993cfbff190b7f3d0149abdf4f94a6785c0815e71c631"
        ),
    ],
