...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.31.0/tuist.artifactbundle.zip",
            checksum: "063e3de2e9abd1f5c5486a56cd68cbcb37cc74f40adc56d3541e70b9d1e297de"
        ),
    ],
