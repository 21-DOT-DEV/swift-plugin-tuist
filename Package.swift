...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.63.2/tuist.artifactbundle.zip",
            checksum: "dc31cbaeef979abe68df196d7262c9a9a8e9f468d027539a76a96916f7a098b2"
        ),
    ],
