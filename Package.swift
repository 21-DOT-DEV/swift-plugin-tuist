...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.130.1/tuist.artifactbundle.zip",
            checksum: "f5e6d73ee35ac1d4bb16be3bf5fef9a423b0c6a27cdc4d669656686a86131511"
        ),
    ],
