...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.57.1/tuist.artifactbundle.zip",
            checksum: "969d26079ef78195b3f76895aa9208a82817cd50085fc7127e9369856cc3d8c7"
        ),
    ],
