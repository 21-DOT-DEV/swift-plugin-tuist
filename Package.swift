...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.21.1/tuist.artifactbundle.zip",
            checksum: "e0f31c69c2912f75aa766b0fd8f61a5f1fcae9c1441bfb12718ac35e88dca54a"
        ),
    ],
