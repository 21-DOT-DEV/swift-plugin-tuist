...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.90.0/tuist.artifactbundle.zip",
            checksum: "9739860e31e1f188faaa8b0aca8797ac5e882897d6ac48bbd624fceaa4edb7fa"
        ),
    ],
