...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.55.6/tuist.artifactbundle.zip",
            checksum: "7ef2423d8871406fe85639c00c384d7e0e93d2f42074c13e33bc275a2623f832"
        ),
    ],
