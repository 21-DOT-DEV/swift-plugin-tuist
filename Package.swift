...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.137.0/tuist.artifactbundle.zip",
            checksum: "4532d30b0ff1fc879c006381cf643c835aefc662f0b33180df76e7159c062d95"
        ),
    ],
