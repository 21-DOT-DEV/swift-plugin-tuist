...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.163.1/tuist.artifactbundle.zip",
            checksum: "1016e15b970558f944bd77cb76d5960d5e410f70da30529b66d7eeb5d5dd43b1"
        ),
    ],
