...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.182.1/tuist.artifactbundle.zip",
            checksum: "49a9d17b06293f3dc46d0fdd6fcae80f2ddcfd633899e75718488722a9e712eb"
        ),
    ],
