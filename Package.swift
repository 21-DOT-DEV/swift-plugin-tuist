...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.116.0/tuist.artifactbundle.zip",
            checksum: "928f90f4324df62de62c65167201aac1803e5092d73636f70e27ec802e630c77"
        ),
    ],
