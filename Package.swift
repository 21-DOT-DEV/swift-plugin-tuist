...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.155.6/tuist.artifactbundle.zip",
            checksum: "5e6905cf7040231d2235a67397a39ed14ff1ad290134defb78be798ebc02ffb2"
        ),
    ],
