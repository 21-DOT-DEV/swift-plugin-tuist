...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.194.3/tuist.artifactbundle.zip",
            checksum: "45ef8535043fcc720b716cdcc255051af9a8c43e10e263ab1bd3b1371e8db16d"
        ),
    ],
