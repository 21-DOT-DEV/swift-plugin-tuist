...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.53.4/tuist.artifactbundle.zip",
            checksum: "e1261ec402197540e48e319ae54c56a4811188aa6d485ad66cceb2fd6c24b804"
        ),
    ],
