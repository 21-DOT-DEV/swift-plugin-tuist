...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.53.0/tuist.artifactbundle.zip",
            checksum: "04e8a904d1579a0c5a1a9c5066b25cb7a33c1b8b9a4eb9f666d15762100c0b04"
        ),
    ],
