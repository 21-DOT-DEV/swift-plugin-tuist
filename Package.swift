...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.122.1/tuist.artifactbundle.zip",
            checksum: "f11c2b2a8cf254ca765868bf7ae536a1455b95e21d484f7657929fff1547e724"
        ),
    ],
