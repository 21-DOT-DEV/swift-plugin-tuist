...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.194.0/tuist.artifactbundle.zip",
            checksum: "db34cd460593c87dcfbfdbec65fa06df34ded5ba2afe761031f2b9c0722be0e5"
        ),
    ],
