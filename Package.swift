...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.146.2/tuist.artifactbundle.zip",
            checksum: "6538724634e7cb21d1ae0e767234f02257a212fa10a2cbeb1ebf21f98f6b87d9"
        ),
    ],
