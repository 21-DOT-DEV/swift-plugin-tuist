...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.194.1/tuist.artifactbundle.zip",
            checksum: "ed09ec3630c5ee0cd49ffa6e39c9f8c72dc2274b901b36ec6fdeb77ca14e0a63"
        ),
    ],
