...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.42.0/tuist.artifactbundle.zip",
            checksum: "59071d9ad3065f63caa58dfd99de2e1c685c09c76c9a0f93460b0961fd56478d"
        ),
    ],
