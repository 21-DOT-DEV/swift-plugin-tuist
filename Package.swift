...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.50.2/tuist.artifactbundle.zip",
            checksum: "423e6e9d2d94be371ad4f5185cb15605f123202f49d0e2c944a611c893bd630c"
        ),
    ],
