...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.157.3/tuist.artifactbundle.zip",
            checksum: "e11cc66356a08edaf87fd17057ffa911ebce61888c3c2c7482ecb1508e45a893"
        ),
    ],
