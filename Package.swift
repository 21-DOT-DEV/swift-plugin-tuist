...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.202.6/tuist.artifactbundle.zip",
            checksum: "401300e97cedd9b2202239c0daa89c7411802bd21bcf830c3360fe163a325818"
        ),
    ],
