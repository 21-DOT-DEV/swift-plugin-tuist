...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.67.1/tuist.artifactbundle.zip",
            checksum: "717c774c7dc42928fd1a8d12e35d6b64552c0b8490e125c0d25039c26b78702c"
        ),
    ],
