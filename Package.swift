...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.188.3/tuist.artifactbundle.zip",
            checksum: "a830b547c2dace714b195357dfe7e24685524566cd8de122fec2b94f67563191"
        ),
    ],
