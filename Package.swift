...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.85.1/tuist.artifactbundle.zip",
            checksum: "5654f16298e5431f1a99b87173bbdf659fb65552a553aa39e223d5d3c074baf7"
        ),
    ],
