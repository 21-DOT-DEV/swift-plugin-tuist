...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.32.0/tuist.artifactbundle.zip",
            checksum: "b2a8e0c491fa62b34a4d5db12eda1cf0ad9a0c8a2b53144f2b624ec291659435"
        ),
    ],
