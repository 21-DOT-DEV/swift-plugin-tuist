...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.143.0/tuist.artifactbundle.zip",
            checksum: "8cd8dcb62395081a92a93ac0d1d8656018cfc04512af24c77232e129eb37ed9d"
        ),
    ],
