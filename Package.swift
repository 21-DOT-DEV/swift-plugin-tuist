...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.47.0/tuist.artifactbundle.zip",
            checksum: "575b17f11c51babdfd8184f58012007faf0436b7277853f3040f607999398e85"
        ),
    ],
