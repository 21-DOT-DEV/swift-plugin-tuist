...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.79.3/tuist.artifactbundle.zip",
            checksum: "0cda7902713582ac1f4a558eba1fd0606110c8176d6073b15f6bbc8bc4b4ce39"
        ),
    ],
