...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.190.0/tuist.artifactbundle.zip",
            checksum: "2a7c5e69cf6a7285e9bf8b0f43043fff7f942b037367f36efea803dba5f8955f"
        ),
    ],
