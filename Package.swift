...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.184.2/tuist.artifactbundle.zip",
            checksum: "a7a0dfd8081b3aa19a5857ec5f7d004b4711effa7e33c43c4be8362ccdfc1392"
        ),
    ],
