...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.22.0/tuist.artifactbundle.zip",
            checksum: "d775db94bfc2055ebaeca2f1898a183b2d4db691b4ba223cc65002a9eda559ef"
        ),
    ],
