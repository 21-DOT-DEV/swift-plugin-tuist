...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.49.0/tuist.artifactbundle.zip",
            checksum: "7bd12ce8205c83905cd8ef3daac321e4ff5398618b2b4a18e62290b61cefa0be"
        ),
    ],
