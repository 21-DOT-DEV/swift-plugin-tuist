...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.197.1/tuist.artifactbundle.zip",
            checksum: "90daa9585b3303047c4747dab8b1625214b7793e67ba9d19dec7f4725d9353f9"
        ),
    ],
