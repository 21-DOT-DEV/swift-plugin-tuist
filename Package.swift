...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.27.0/tuist.artifactbundle.zip",
            checksum: "ddbcb39b95fc37797fff16ef8fe79b3540770cb1a705966d6f3d8b98ca2ebdd1"
        ),
    ],
