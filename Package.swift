...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.188.0/tuist.artifactbundle.zip",
            checksum: "403ce788a18b03d6e603a2b9101cd9b4f01d1ef8888a1cefe7b1225dc52875fe"
        ),
    ],
