...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.110.3/tuist.artifactbundle.zip",
            checksum: "f76c152bef2a8e8f271674e028088f36d6ac067208bcadbc3328971bdba2c80d"
        ),
    ],
