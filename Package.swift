...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.63.3/tuist.artifactbundle.zip",
            checksum: "463022df6c4c27f62ab363428afac2e5c5a93dbce4270b5f6a75f997af6504cd"
        ),
    ],
