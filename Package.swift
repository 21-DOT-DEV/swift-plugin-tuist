...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.26.0/tuist.artifactbundle.zip",
            checksum: "17b62cb6a9d638d124798379236d54c0039f12b3ab3ce0145102bbcf2bc6c5f5"
        ),
    ],
