...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.151.0/tuist.artifactbundle.zip",
            checksum: "baf64cfac84c162cb4231b5ae6e04a2beac51e3e2778aa16402221a84b9256aa"
        ),
    ],
