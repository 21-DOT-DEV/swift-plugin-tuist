...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.185.1/tuist.artifactbundle.zip",
            checksum: "a7411e1668f4d21224eb27a03422345ffbb1977d096272b072d86da86431a9d3"
        ),
    ],
