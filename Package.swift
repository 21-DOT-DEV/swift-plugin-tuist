...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.154.5/tuist.artifactbundle.zip",
            checksum: "215bdf1db3288b423638c2523997967600b0f31e1570e8e10d92dcd0c499ff92"
        ),
    ],
