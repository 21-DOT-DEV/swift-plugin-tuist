...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.45.0/tuist.artifactbundle.zip",
            checksum: "f451814ffd56827b0302396e75eeabbe8b3d2f424567fa7cb596a306ec116850"
        ),
    ],
