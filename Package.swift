...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.68.0/tuist.artifactbundle.zip",
            checksum: "b8971bbe96309ca605737ef4c7c26cbb88c389a14596be25683c5f6e5f1ad5cc"
        ),
    ],
