...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.112.0/tuist.artifactbundle.zip",
            checksum: "653ab9aa28755960ebb0d7bbe225a3d2510fc42ed60640306ba04f31ee5e6b52"
        ),
    ],
