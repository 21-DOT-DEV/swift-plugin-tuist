...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.153.1/tuist.artifactbundle.zip",
            checksum: "90ef8a00b7c7e551122f0d6323c6aed76a95fba6ebb8d582e235ff1948ebd06d"
        ),
    ],
