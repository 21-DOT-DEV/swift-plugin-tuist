...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.142.1/tuist.artifactbundle.zip",
            checksum: "fb37b91e9102e1eb38a539b8fa06a4a90d1868563e43bd19a6295bbccf594514"
        ),
    ],
