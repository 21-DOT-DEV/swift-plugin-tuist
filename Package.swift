...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.30.0/tuist.artifactbundle.zip",
            checksum: "511aad1394849b1fdd59a4cea5cae18e098cfa4f4b7e709e88749660326b79f4"
        ),
    ],
