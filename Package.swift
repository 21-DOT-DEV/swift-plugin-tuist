...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.70.0/tuist.artifactbundle.zip",
            checksum: "1e71f17a4d6265fd8b9a6bf7bd4103ccd4b6b7cd10afbdd39317cbe32ffbebe5"
        ),
    ],
