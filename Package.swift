...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.183.1/tuist.artifactbundle.zip",
            checksum: "904610cd0ac0884dab66ee7b37c6d0763569f78dfcf9d41a6c004f9203f9b242"
        ),
    ],
