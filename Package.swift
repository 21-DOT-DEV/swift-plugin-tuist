...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.110.0/tuist.artifactbundle.zip",
            checksum: "ab6560f85a1bf9945f54e6e475da41860efc0df6bf1606fc2c3b83dc6cb704f5"
        ),
    ],
