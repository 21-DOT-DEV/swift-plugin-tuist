...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.122.0/tuist.artifactbundle.zip",
            checksum: "6ff74188bbbf5a4ef56e8958e650c7f6ba1f30cc61921591748edc08006497f2"
        ),
    ],
