...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.55.9/tuist.artifactbundle.zip",
            checksum: "91acbdbde89ee957169c45004583d7bb8b8c41021fd2870f7bb4bc974fae8589"
        ),
    ],
