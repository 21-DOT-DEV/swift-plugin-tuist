...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.195.16/tuist.artifactbundle.zip",
            checksum: "ba4e061f92c8adef86837bfa44641ea7d1c7d8b6a3a14537933db18d7ea66743"
        ),
    ],
