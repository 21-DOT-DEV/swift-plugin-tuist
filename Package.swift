...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.132.0/tuist.artifactbundle.zip",
            checksum: "7b53de6a61f4392dd4807271b0b2fc6ec1d999ef16271837ac4538b124474149"
        ),
    ],
