...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.24.0/tuist.artifactbundle.zip",
            checksum: "044827435472d5d2e935da7ddb6c409eb09cec0d154d8972e18f895cdf83c639"
        ),
    ],
