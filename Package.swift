...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.55.2/tuist.artifactbundle.zip",
            checksum: "6dbf34aa9f3af74acf6a1e7457350489fabfd05627b78024f707d8282da45031"
        ),
    ],
