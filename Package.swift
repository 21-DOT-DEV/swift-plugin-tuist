...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.102.0/tuist.artifactbundle.zip",
            checksum: "b9494f102e42729021f7335097aeb06baab856b30cca22e1c6869a7854474277"
        ),
    ],
