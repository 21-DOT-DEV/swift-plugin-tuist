...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.144.4/tuist.artifactbundle.zip",
            checksum: "4cb6277a9738e5fa8beba59e65db29b4396b7b538806aa87ee2c72da465620d3"
        ),
    ],
