...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.140.1/tuist.artifactbundle.zip",
            checksum: "7f75d631c280ea4acb4afa7b6cb73343fc48d77c2e50dc0ec5d9594778e9e447"
        ),
    ],
