...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.28.1/tuist.artifactbundle.zip",
            checksum: "4b57d7950af84eb01add6f015b030b1a7818f8c906dfad0e755b417964528998"
        ),
    ],
