...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.103.0/tuist.artifactbundle.zip",
            checksum: "d5ad2d2eb0721547676d3eed5b70c21651d967dd3e2b9326e593410ecd932b42"
        ),
    ],
