...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.65.7/tuist.artifactbundle.zip",
            checksum: "10092c456c902cb9bdf25a02bfc6e8c24c938c20196275c19b596336b542e841"
        ),
    ],
