...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.61.0/tuist.artifactbundle.zip",
            checksum: "3e569ebbb7f0d57f1e2029b2b512b53c29d863627abe7e954a3c3521a9e1e846"
        ),
    ],
