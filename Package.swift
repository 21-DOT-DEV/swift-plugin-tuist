...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.134.0/tuist.artifactbundle.zip",
            checksum: "9f6ffd92cab5c8bcec78bc70ff8912b6d2b582ef103ce46fe1ad83301c2949f2"
        ),
    ],
