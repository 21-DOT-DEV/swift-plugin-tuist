...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.195.1/tuist.artifactbundle.zip",
            checksum: "07edd8229ca0ebb6cd2b59641e449609b646e6b72ff3cd0db6b650e45d62d5d1"
        ),
    ],
