...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.140.2/tuist.artifactbundle.zip",
            checksum: "3bda004a2f75be215c4a1dce06a7e044572b6ee711ed24f7495ce76b0cf6b752"
        ),
    ],
