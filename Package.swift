...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.199.0/tuist.artifactbundle.zip",
            checksum: "d8e61593acce2b1af37f95f4913139a8f547859765aec31e27f302f6e19d975b"
        ),
    ],
