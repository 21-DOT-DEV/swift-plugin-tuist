...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.184.1/tuist.artifactbundle.zip",
            checksum: "f5534d12294ca783efc5d3fb09795384d6ecb30b06d6c9a9078f05c19ef753ed"
        ),
    ],
