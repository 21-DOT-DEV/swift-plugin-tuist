...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.174.2/tuist.artifactbundle.zip",
            checksum: "a44e559df0aea192dcb7d972ed04228db76f6934fe12a861098cce27bf99141c"
        ),
    ],
