...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.133.1/tuist.artifactbundle.zip",
            checksum: "ab20754588e86f67b4c8e1169fe84add6f6e9ceab5269dda2ea157a86ec5955c"
        ),
    ],
