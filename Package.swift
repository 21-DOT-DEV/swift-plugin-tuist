...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.197.3/tuist.artifactbundle.zip",
            checksum: "7ee2734e9a288bd53d7329ab68271e15ad05ff6790d9c9412b9f104e928cbbce"
        ),
    ],
