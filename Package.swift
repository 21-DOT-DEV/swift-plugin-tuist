...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.151.1/tuist.artifactbundle.zip",
            checksum: "a2d2e1efde32825facd4689a1fcdccdb12cf212de0ed8e6dec2987a2d638bfaf"
        ),
    ],
