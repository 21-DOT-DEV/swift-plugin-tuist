...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.116.2/tuist.artifactbundle.zip",
            checksum: "817ef423a7bb7996085b6dfc4a1f97b9f33aff3a5251798c090b248c448c8774"
        ),
    ],
