...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.191.7/tuist.artifactbundle.zip",
            checksum: "6352a6ac305e722533467303cc091d826f7f0b63d54ef23338f3eee5fa39f2e5"
        ),
    ],
