...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.56.0/tuist.artifactbundle.zip",
            checksum: "59cb8d6e65e02001c98360a84c4d42f95d5fc9968204a7602181c3a87cc1af0e"
        ),
    ],
