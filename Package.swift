...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.111.1/tuist.artifactbundle.zip",
            checksum: "dde0ea7f8264225ed13f19d61f3d0d64d6619791df90d086eac3922ea2c89546"
        ),
    ],
