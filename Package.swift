...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.160.0/tuist.artifactbundle.zip",
            checksum: "dd2d12c2ce5f6fe70bec3cec1d7fcd9160303dd7e43f04fc497d1984eb7bdbf5"
        ),
    ],
