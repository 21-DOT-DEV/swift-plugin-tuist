...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.139.1/tuist.artifactbundle.zip",
            checksum: "f04af1cd20fb3f7ff48783a3ba9954075d089f99ff01afbf6f4bfabce400453d"
        ),
    ],
