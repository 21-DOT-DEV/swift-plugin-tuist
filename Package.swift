...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.121.0/tuist.artifactbundle.zip",
            checksum: "56991cc16f10169cf30ff78d519dc7d4b20d8162decb42562dd117529fe3f303"
        ),
    ],
