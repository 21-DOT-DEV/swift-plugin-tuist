...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.196.1/tuist.artifactbundle.zip",
            checksum: "87bf488eeae802bb4f9c86bd7cd8518703b4e3154979975231f70f5598be341c"
        ),
    ],
