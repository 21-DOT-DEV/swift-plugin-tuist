...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.178.0/tuist.artifactbundle.zip",
            checksum: "80edc89bb75003824fd672aea3b5fbd905f0491a1e710b344ac409b613a69eec"
        ),
    ],
