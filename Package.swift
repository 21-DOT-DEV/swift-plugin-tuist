...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.133.0/tuist.artifactbundle.zip",
            checksum: "787a5b0aeee51dc9e7f6969b20772ed039a73aac5e8a67085ab5075a979a56a0"
        ),
    ],
