...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.64.0/tuist.artifactbundle.zip",
            checksum: "ee8c75415b7cd7681684d02745368664b315d80d49f6ce8ce8de8d4af86b41f4"
        ),
    ],
