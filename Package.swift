...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.19.0/tuist.artifactbundle.zip",
            checksum: "3dcd0c9889127cfd640d1e111593821161d6151916e0bf767549ee316b8d8f8b"
        ),
    ],
