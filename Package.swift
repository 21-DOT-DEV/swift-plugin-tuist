...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.109.1/tuist.artifactbundle.zip",
            checksum: "dcc1d13babc88c1d6e0707b39ed0c0ce786f9f438f48382294c793724bb77b31"
        ),
    ],
