...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.154.0/tuist.artifactbundle.zip",
            checksum: "27c3a2f80674d57d6cc7d1d5ab70801f03e84e41b224c49426a23b074bd86a27"
        ),
    ],
