...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.114.0/tuist.artifactbundle.zip",
            checksum: "173cd20dcb3853e1cfe0f9dd788d0bd5f1df8042f5d008c06869c5baa1fdebc9"
        ),
    ],
