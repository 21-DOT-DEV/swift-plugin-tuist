...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.131.1/tuist.artifactbundle.zip",
            checksum: "feec6830fe5ba30426dec7647be1dc824444d9c729e4245be17a527ded605388"
        ),
    ],
