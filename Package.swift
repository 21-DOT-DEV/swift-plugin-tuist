...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "tuist",
            url: "https://github.com/21-DOT-DEV/swift-plugin-tuist/releases/download/4.51.2/tuist.artifactbundle.zip",
            checksum: "944384dbb4c0d5d42f484a3cab2ce75267bfce360c34ee1af208de28edf60429"
        ),
    ],
